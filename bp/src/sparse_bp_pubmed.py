...
if __name__ == "__main__":
	...
	observed_belief_1_hot_centered 	= observed_belief_1_hot - 1 / num_classes

	edge_H_centered 			= edge_H - 1 / num_classes
	...
	for _ in range(11):
		...
		# posterior_belief[(geometric_graph.val_mask == False)] = observed_belief_1_hot_centered[(geometric_graph.val_mask == False)]

		loss = loss_fnct(posterior_belief[geometric_graph.val_mask == True], prior_belief[geometric_graph.val_mask == True])
		print(loss)
